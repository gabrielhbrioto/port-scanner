...
- 🖇️ Instalação simples do script no sistema com um link simbólico.
...
3. **Executando dentro do ambiente virtual**
   ...
   Uma vez que o ambiente virtual já exista, basta seguir os passos apresentados na subseção anterior. Além disso, para remover o ambiente virtual, basta executar:
